...
Контракты:
    ...
    - append_log_separator():
        ...
        * если файл ещё не существует, старше min_mtime или separator пустой —
          ничего не делает;
...
def append_log_separator(
    ...
    *,
    ...
    :param min_mtime: Минимальный mtime файла, начиная с которого
                      разрешено ставить разделитель. Если файл старше,
    ...
    # Разделитель добавляем только если лог менялся в текущем запуске.
