...
- **Папка `ApilFCExporter`**  
  ...
  > Папку `ApilFCExporter` и имя файла `Autodesk.IFC.Export.UI.dll`
...
> Важно: папки и файлы внутри `_settings` (включая `ApilFCExporter`, `settings.ini` и др.)
